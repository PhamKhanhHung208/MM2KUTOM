...
Converted["_TextLabel4"].Text = "KuTom ESP"
...
Converted["_NotificationSample"].Position = UDim2.new(0.699999988, 0, 0.899999976, 0)
    ...
    local function module_script()
		...
		function FUNCTIONSmodule.notification(s, color, icon)
			...
			task.spawn(function()
				...
				notif.Position = UDim2.fromScale(0.7, 1.2)
				...
				local finish = ts:Create(notif, TweenInfo.new(0.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
					Position = UDim2.fromScale(0.7, 1.2)
				})
				finish:Play()
...
local function CUOWHV_fake_script() -- Fake Script: ServerStorage.YARHM.Open.InitOpen
...
local function FDBY_fake_script() -- Fake Script: ServerStorage.YARHM.Open.OnClick
    local script = Instance.new("LocalScript")
    script.Name = "OnClick"
    script.Parent = Converted["_Open"]
    local req = require
...
local function GLVFOK_fake_script() -- Fake Script: ServerStorage.YARHM.Open.Resizer
    local script = Instance.new("LocalScript")
    script.Name = "Resizer"
    script.Parent = Converted["_Open"]
    local req = require
...
local function ABOBNLY_fake_script() -- Fake Script: ServerStorage.YARHM.Init
    local script = Instance.new("LocalScript")
    script.Name = "Init"
    script.Parent = Converted["_YARHM"]
    local req = require
...
local function TUCSBN_fake_script() -- Fake Script: ServerStorage.YARHM.FloatingButton.Keybinding
    local script = Instance.new("LocalScript")
...
local function PBVMZXA_fake_script() -- Fake Script: ServerStorage.YARHM.FloatingButton.Invisible
    local script = Instance.new("LocalScript")
...
local function RCBELM_fake_script() -- Fake Script: ServerStorage.YARHM.AddCustomModule.Add.LocalScript
    local script = Instance.new("LocalScript")
...
local function OQAIWTJ_fake_script() -- Fake Script: ServerStorage.YARHM.AddCustomModule.Cancel.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function UIWD_fake_script() -- Fake Script: ServerStorage.YARHM.Menu.UIStroke.UIGradient.Animator
    local script = Instance.new("LocalScript")
...
local function IVBILD_fake_script() -- Fake Script: ServerStorage.YARHM.Menu.List.AutoSetup
    local script = Instance.new("LocalScript")
...
local function DOUANJJ_fake_script() -- Fake Script: ServerStorage.YARHM.Menu.AddCustomModule.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function IRYCIX_fake_script() -- Fake Script: ServerStorage.YARHM.Menu.Close.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function CPDRMDJ_fake_script() -- Fake Script: ServerStorage.YARHM.Menu.CloseArea.CloseOpen
    local script = Instance.new("LocalScript")
...
local function BXUU_fake_script() -- Fake Script: ServerStorage.YARHM.Flee the Facility
    local script = Instance.new("LocalScript")
...
local function FYPVEQ_fake_script() -- Fake Script: ServerStorage.YARHM.Murder Mystery 2
    local script = Instance.new("LocalScript")
	...
	table.insert(module, {
		Type = "Button",
		Args = {"SHOOT MURDER(TOMSEX)", function(Self)
			if findSheriff() ~= localplayer then 
				fu.notification("MAY CO SUNG KHONG MA DOI KILL?") 
				return 
			end
	
			local murderer = findMurderer()
			if not murderer then
				fu.notification("MURDER CHET CU LAU R")
				return
			end
...
local function BOHA_fake_script() -- Fake Script: ServerStorage.YARHM.Universal
    local script = Instance.new("LocalScript")
...
coroutine.wrap(CUOWHV_fake_script)()
coroutine.wrap(FDBY_fake_script)()
coroutine.wrap(GLVFOK_fake_script)()
coroutine.wrap(ABOBNLY_fake_script)()
coroutine.wrap(TUCSBN_fake_script)()
coroutine.wrap(PBVMZXA_fake_script)()
coroutine.wrap(RCBELM_fake_script)()
coroutine.wrap(OQAIWTJ_fake_script)()
coroutine.wrap(UIWD_fake_script)()
coroutine.wrap(IVBILD_fake_script)()
coroutine.wrap(DOUANJJ_fake_script)()
coroutine.wrap(IRYCIX_fake_script)()
coroutine.wrap(CPDRMDJ_fake_script)()
coroutine.wrap(BXUU_fake_script)()
coroutine.wrap(FYPVEQ_fake_script)()
coroutine.wrap(BOHA_fake_script)()